...
read -p "Pic a Soap cuttof. For large cutoff, make sure to use a dense grid.[1.0 - 10.0] " rcut

l=9

n=3

read -p "Pic a buble size . \n This will determine the surface.  make sure to check if the surface was defined correctly
...
read -p "Pic a grid density .Usually the smallest is accurate enough: [1-7] " grid

read -p "Select Atom Types.e.x. type \"Au Cu\" but without the quotations: " atoms
